...
public class ImageCut {
	...
	public static void scale(String srcImageFile, String result, int _width,int _height,int x,int y) {
		try {
			...
			Image image = src.getScaledInstance(Convert.toIntValue(width), Convert.toIntValue(height),Image.SCALE_DEFAULT);
			BufferedImage tag = new BufferedImage(Convert.toIntValue(width), Convert.toIntValue(height),BufferedImage.TYPE_INT_RGB);
			Graphics g = tag.getGraphics();
