      ...
      <div class="zwnews">
          ...
          <div class="zwnews_left">
           ...
           <p><label class="color_c">领域：</label>
           		<c:if test="${jobs.filedes == '' || jobs.filedes == null}">未提供</c:if>
           		<c:if test="${jobs.filedes != '' && jobs.filedes != null}">${jobs.filedes }</c:if>
           		</p>
         ...
         <!-- 只显示三个职位 -->
       		...
       		<c:if test="${jobs.id3 != '' && jobs.id3 != null }">
       		 <div class="zwnews_right" style="padding-bottom:30px;">
         		...
         		<div class="tjl_ag"><a id="moverGz" target="_blank" href="c/index/${jobs.companyId }" ><input type="button" class="btn_tjlm" title="更多"></input></a></div>
       		</div>
       		</c:if>
