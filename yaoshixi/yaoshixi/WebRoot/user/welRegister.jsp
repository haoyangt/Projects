...
<body>
	<div style="width:800px;margin:0 auto;line-height:28px;font-size:16px;">
        <div style="padding:0 0 0 80px; width:600px;font-family:"宋体";">
        	...
        	<p style="margin:0;">${email }.com，您好,你已成功加入要实习网！</p>
        	<p style="margin:0;">为回馈您对<b>要实习™</b>的支持，您可以获得一次世界500强人力资源专员免费协助修改简历的机会。</p>
       		<p style="margin:0;">请将本人简历以附件形式发送至<a href="mailto:cv@yaoshixi.com" style="text-decoration:underline;color:#0000FF;">cv@yaoshixi.com</a>（邮件标题请命名为: 修改简历+<strong>要实习™</strong>账号名+邮箱）<br/>
				我们将会在5个工作日内将简历修改意见回复至您邮箱。<br/> 如有疑问,可直接发送邮件至 <a href="mailto:cs@yaoshixi.com" style="text-decoration:underline;color:#0000FF;">cs@yaoshixi.com</a>
			</p>
           <br/>
