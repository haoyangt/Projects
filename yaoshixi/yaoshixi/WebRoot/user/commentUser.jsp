	...
	<form class="tb_int" action="" method="post">
		...
		<table>
			...
			<tr>
				<td></td>
				<td>
					<p style="width:450px;margin-top:20px"><input class="btn_style1" id="sendEmail" type="button" value="提交"><input class="btn_cancel" type="button" onclick="closeWindow();" value="取消"></p>
				</td>
			</tr>
		</table>
	</form>
