...
if (isAnimating) return;
	last.row = now.row;
	last.col = now.col;
	if (last.row==3 &&last.col<1) { now.row = last.row; now.col = last.col+1; pageMove(towards.left);}	
})
...
$(document).swipeRight(function(){
	...
	last.row = now.row;
	last.col = now.col;
	if (last.row==3 && last.col>1) { now.row = last.row; now.col = last.col-1; pageMove(towards.right);}
...
var pop_up_note_mode = true;
        ...
        function playbksound() {
            ...
            if (document.body.offsetWidth > 400) {
                ...
                bg_htm = "<img id='sound_image' width='30;px' src='img/music_note_big.png'>";
