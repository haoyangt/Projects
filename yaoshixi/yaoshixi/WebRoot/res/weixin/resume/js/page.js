function ddd(n,d){
	...
	function yixbiaoqz(s,obj){
		var spn = document.getElementById("yx"+s+"");
		if(obj=="tieshang"){
			spn.outerHTML = "";
			$.ajax({
				type:'POST',
		...
		if(div1.children.length<8){
			...
			if(falg || div1.children.length == 0){
				$.ajax({
				 ...
				 $("#yixuanbq").append("<span name=\"tagName"+num+"\" id=\"yx"+s+"\" onclick=\"yixbiaoqz('"+s+"',this)\">"+s+"</span>");
				  spn.outerHTML = "";
				  $("#tishi").text("");
				  return;
			}else{
			...
			if(div2.children.length<8){
				...
				if(falg){	
			    	...
			    	if(fals || div2.children.length == 0){
					    ...
					    $("#yixuanbq").append("<span id=\"yx"+zdybiaoq+"\" onclick=\"yixbiaoqz('"+zdybiaoq+"','tieshang')\">"+zdybiaoq+"</span>");
					    //$("#zdybiaoq").val("");
					    $("#tishi").text("");
					    return;
			    	}else{
		...
		if(div1.children.length<8){
			...
			if(falg || div1.children.length == 0){
				...
				if(jobRequest != ""){
				 ...
				 $("#yixuanzsbq").append("<span name=\"tagName"+num+"\" id=\"yx"+s+"\" onclick=\"yixuanzsbq('"+s+"',this)\">"+s+"</span>");
				  spn.outerHTML = "";
				  $("#zstishi").text("");
				  return;
			}else{
			...
			if(div2.children.length<8){
				...
				if(falg){	
			    	...
			    	if(fals || div2.children.length == 0){
					    ...
					    $("#yixuanzsbq").append("<span id=\"yx"+zdybiaoq+"\" onclick=\"yixuanzsbq('"+zdybiaoq+"','tieshang')\">"+zdybiaoq+"</span>");
					    //$("#zdybiaoq").val("");
					    $("#zstishi").text("");
					    return;
			    	}else{
		...
		if(div1.children.length<8){
			...
			if(falg || div1.children.length == 0){
				...
				if(jobRequest != ""){
				 ...
				 $("#yixuanjnbq").append("<span name=\"tagName"+num+"\" id=\"yx"+s+"\" onclick=\"yixuanjnbq('"+s+"',this)\">"+s+"</span>");
				  spn.outerHTML = "";
				  $("#jntishi").text("");
				  return;
			}else{
			...
			if(div2.children.length<8){
				...
				if(falg){	
			    	...
			    	if(fals || div2.children.length == 0){
					    ...
					    $("#yixuanjnbq").append("<span id=\"yx"+zdybiaoq+"\" onclick=\"yixuanzsbq('"+zdybiaoq+"','tieshang')\">"+zdybiaoq+"</span>");
					    //$("#zdybiaoq").val("");
					    $("#jntishi").text("");
					    return;
			    	}else{
		...
		if(div1.children.length<8){
			...
			if(falg || div1.children.length == 0){
				...
				if(jobRequest != ""){
				 ...
				 $("#yixuanjlbq").append("<span name=\"tagName"+num+"\" id=\"yx"+s+"\" onclick=\"yixjlbiaoqz('"+s+"',this)\">"+s+"</span>");
				  spn.outerHTML = "";
				  $("#jltishi").text("");
				  return;
			}else{
			...
			if(div2.children.length<8){
				...
				if(falg){	
			    	...
			    	if(fals || div2.children.length == 0){
					    ...
					    $("#yixuanjlbq").append("<span id=\"yx"+zdybiaoq+"\" onclick=\"yixjlbiaoqz('"+zdybiaoq+"','tieshang')\">"+zdybiaoq+"</span>");
					    //$("#zdybiaoq").val("");
					    $("#jltishi").text("");
					    return;
			    	}else{
			...
			if(div2.children.length<8){
				...
				if(falg){	
			    	...
			    	if(fals || div2.children.length == 0){
					    ...
					    $("#yixuanahbq").append("<span id=\"yx"+zdybiaoq+"\" onclick=\"yixahbiaoqz('"+zdybiaoq+"','tieshang')\">"+zdybiaoq+"</span>");
					    //$("#zdybiaoq").val("");
					    $("#ahtishi").text("");
					    return;
			    	}else{
