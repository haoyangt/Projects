                    ...
                    if (cursorPosition >= sliderLeft && cursorPosition <= (sliderRight + 10)) {
                        if (trackerPosition >= 0 && trackerPosition <= sliderWidth + 4) {
                            ...
                            if(currentHandle != 'left'){
                                ...
                                var cVal = newPosition / tickWidth; 
                                ...
                                val = parseInt(val);
                                var tmpEnd = val;
                                var tmpStart = selectionStart;
                            	if(tmpEnd > 2*tmpStart){
                            		trackerPosition = 2*tmpStart*tickWidth + sliderLeft;
                            	}
                            }
                            */
                            ...
                            if (handle != null) {
                                ...
                                toolTip.css('left', handle.offset().left-150);
                            }
