...
<div id="page">
  <div class="cont">
    ...
    <section class="login">
    <form action="user/registryEditor" method="post">
	     <div class="jj">
	       <input name="email" id="email" value="${email}" type="text" class="txtname" validate="email::请输入常用邮箱" placeholder="请输入登录邮箱地址">
	       <p></p>
	    ...
	    <div class="jj">
	    	...
	    	<input type="button" onclick="userLogin()" class="btnlg" value="登&nbsp;&nbsp;&nbsp;&nbsp;录">
	    </div>
	    <div class="jj">
	    	<a href="m/regist.jsp"><input type="button" class="btnlg" value="注&nbsp;&nbsp;&nbsp;&nbsp;册"></a>
	    </div>
    </form>
    </section>
