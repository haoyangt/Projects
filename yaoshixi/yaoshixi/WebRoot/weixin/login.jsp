  ...
  <div class="cont">
    ...
    <form action="user/loginUser" method="post">
	    ...
	    <div class="jj">
	    	...
	    	<p style="color:#007DD1;font-size:12px;">登录 联系你的HR（已在要实习网站注册的用户可通用账号密码）</p>
	    	<input type="button" onclick="userLogin()" class="btnlg" value="登录 联系你的HR">
	    </div>
	    <div class="jj">
	        <p style="color:#007DD1;font-size:12px;">第一次来？60秒创建闪聘招牛人</p>
	    	<a href="m/regist.jsp"><input type="button" class="btnlg" value="第一次来？60秒创建闪聘招牛人"></a>
	    </div>
    </form>
    </section>
