...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="admin/companyReview/authenticationIndex" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar"> 
			<li><a class="edit" href="admin/companyReview/authentication/{sid_companyId}" height="550" width="900" target="dialog" rel="company_reviewPage"><span>验证企业</span></a></li>
		</ul>
	</div>
