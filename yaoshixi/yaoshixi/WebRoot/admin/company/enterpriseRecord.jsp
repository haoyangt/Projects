...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="112">
		<thead>
			<tr>
				<th width="260">时间</th>
				<th width="220">今日注册用户量</th>
				<th width="220">今日激活用户量</th>
				<th width="220">今日用户登录量</th>
				<th width="220">今日新增职位量</th>
				<th width="220">今日面试通知量</th>
				<th width="220">今日录用量</th>
				<th width="220">今日拒绝量</th>
				<th width="220">微信绑定量</th>
			</tr>
		</thead>
		<tbody>
			...
			<c:forEach var="data" items="${page.results}">
				<tr>
					...
					<td>${data.companyRegist}</td>
					<td>${data.companyUser}</td>
					<td>${data.companyLogin}</td>
					<td>${data.newJobs}</td>
					<td>${data.interview}</td>
					<td>${data.employQuantity}</td>
					<td>${data.refused}</td>
					<td>${data.companyWeixinNum}</td>
				</tr>
			</c:forEach>
		</tbody>
	</table>
