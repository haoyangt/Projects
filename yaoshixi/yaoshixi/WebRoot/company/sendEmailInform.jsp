...
<body>
	<div style="width:800px;margin:0 auto;line-height:28px;font-size:16px;">
        <div style="padding:0 0 0 80px; width:600px;font-family:"宋体";">
        	...
        	<p style="margin:0;">您所发布的（${jobName}）又有一位新的应聘者，点击以下链接直接查看应聘者简历。</p>
			<p style="margin:0;">
				<a href="${validateUrl }" style="text-decoration:underline;color:#0000FF;">${validateUrl }</a>
			</p>
			<p style="margin:0;">如无法点击，请将链接拷贝到浏览器地址栏中直接访问。</p>
			<p style="margin:0;">在简历页面点击“通知面试”可以直接发送面试通知到应聘者的邮箱哦！</p>
			<p style="margin:0;">（为了保证招聘信息的质量，我们会在职位发布15天后强制下线，所以请尽快处理收到的申请。）</p>
           <br/>
