 ...
 <form class="tb_int" id="internForm">
	...
	<table >
		...
		<tr>
			...
			<td>
				<input name="intern.hireDate" id="sj" type="text" validate="required::请输入日期" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});" placeholder="请选择日期" class="login_input login_input_w login_input_bg" /> 
				<input name="intern.hour" id="sj" type="text" style="width:80px" validate="required::请输入时间" onclick="WdatePicker({dateFmt:'HH:mm'});" placeholder="请选择日期" class="login_input login_input_w" /> 
			</td>
		</tr>
		<tr>
			<td><span class="bt">*</span>入职地址：</td>
			<td><input name="intern.officeAddress" id="dz" type="text" value="${company.addr }" validate="required::请输入地址"  placeholder="默认公司地址" class="login_input login_input_w" /></td>
		</tr>
		<tr>
			<td><span class="bt">*</span>联系人：</td>
			<td><input name="intern.linkman" id="lzr" type="text" validate="required::请输入联系人" class="login_input" /></td>
		</tr>
		<tr>
			<td><span class="bt">*</span>联系电话：</td>
			<td><input name="intern.phone" id="dh" type="text" validate="required::请输入联系电话" class="login_input" /></td>
		</tr>
		<tr>
			<td>入职职位：</td>
			<td><input name="intern.jobName" id="jobNamess" type="text" readonly="readonly" class="login_input" value="${jobName }" /></td>
		</tr>
