	      ...
	      <div class="instructions" style="margin-bottom:10px;"> 
	     	 ...
	     	 <fieldset>
	     	  	<legend>请选择jpg图片(图片较大，请耐心等待)：</legend>
		    		...
		    		<form id="photoForm" action="organizationCode" onsubmit="return uploadAjaxForm(this);" style="text-align:right">
				  		<input type="hidden" name="x" value=""/>
				  		<input type="hidden" name="y" value=""/>
				  		<input type="hidden" name="width" value=""/>
				  		<input type="hidden" name="height" value=""/>
				  		<input type="hidden" id="uploadedPhotoName" name="photoName" value=""/>
				  		<input type="submit"  id="upload_target" value="上传"  class="btnup">
				  	</form>
	     	 </fieldset>
