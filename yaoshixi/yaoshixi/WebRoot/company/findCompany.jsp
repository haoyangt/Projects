...
<div  style="height: 100%;">
	...
	<div class="zhank"></div>
 	...
 	<div class="step_ps"><div class="step1"><span>1</span>输入激活码和公司邮箱地址——<span>2</span>邮箱验证</div><div class="step2">——<span>3</span>激活成功</div></div>
 	
     <div style="float:left;width:500px;padding-left:80px;">
        	<h2>验证邮箱，激活公司邮箱</h2>
        	<p>激活公司邮箱邮件已发送至你的邮箱：<font style="color: red;">${email }</font></p>
       		<p>
