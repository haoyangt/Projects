	...
	require(["jquery", "artLab", "res/artDialog/dialog-iframe"], function($, artLab, art){
		$('a').each(function () { 
    	    $(this).click(function(){  
    	    	...
    	    	dialog.get("artBoxForCurrentCity").data.currentCity = $(this).html();
    	    	dialog.get("artBoxForCurrentCity").data.currentCityId = $(this).attr('name');
    	    	dialog.get("artBoxForCurrentCity").close();
    	    });  
    	}); 
	});
