...
<body>
	<div style="width:800px;margin:0 auto;line-height:28px;font-size:16px;">
        <div style="padding:0 0 0 80px; width:600px;font-family:"宋体";">
        	...
        	<p style="margin:0;">我们是要实习™招聘网。 </p>
        	<p style="margin:0;">在要实习™网站上您有未处理简历<strong>${num }</strong>封！</p>
       		<p>点击此链接：<a target="_blank" href="http://www.yaoshixi.com/company/activate.jsp" style="text-decoration:underline;color:#0000FF;">http://www.yaoshixi.com/company/activate.jsp</a></p>
       		<p style="margin:0;">输入激活码<strong>${cdkey }</strong>即可一键关联该职位，马上查看相关职位的应聘者哦！<p>
