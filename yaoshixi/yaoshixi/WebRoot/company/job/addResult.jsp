...
<title>职位发布-要实习-专注于实习生招聘的互联网平台</title>
...
<div id="body">
	...
	<div id="main">
	    ...
	    <div class="container">
	        ...
	        <div class="kt_zw">
	       		<div class="login_top">
	            	<div class="kt_title">发布新职位</div>
	            </div>
	            <p class="tshi">恭喜你，职位发布成功！&nbsp;&nbsp;<a href="jobDetail/${jobId}" class="hover_g">预览职位 >></a><p>
	            <p class="tshi_2"><a href="company/job/addEdit" class="hover_under">继续发布新职位</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="company/index"  class="hover_under">进入我的公司主页</a></p>
	          <div class="s_l">
