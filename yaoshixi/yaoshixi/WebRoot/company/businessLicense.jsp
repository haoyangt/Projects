...
<title>上传营业执照-要实习-专注于实习生招聘的互联网平台</title>
...
<script src="res/imgAreaSelect/jquery.imgareaselect.pack.js"></script>
<script src="res/js/ajaxfileupload.js"></script>

<script src="res/ajax/ajaxdialog.js"></script>
<style type="text/css">
.btnup
{
...
function preview(img, selection) {
    ...
    var scaleX = 350 / (selection.width || 2);
    var scaleY = 350 / (selection.height || 2);
...
/* $(function () {
    $('#photo').imgAreaSelect({ x1: 120, y1: 90, x2: 280, y2: 210,
        fadeSpeed: 400, onSelectChange: preview });
}); */
	...
	<div class="container demo">
	  <div style="float: left; width: 99%;">
	      <div class="instructions" style="margin-bottom:10px;"> 
	     	 ...
	     	 <fieldset>
	     	  	<legend>请选择jpg图片(图片较大，请耐心等待)：</legend>
		     		 <input type="file"  name="logo" id="uploadImage" value="" accept="image/*"  onchange="ajaxUploadImg()"/>
		    		<form id="photoForm" action="businessLicense" onsubmit="return uploadAjaxForm(this);" style="text-align:right">
	    ...
	    <div id="photoDiv" class="frame"  style=" width: 800; height: 600;display:none;">
	      <div style="width:800px; height:500px; float:left;">
	      		<img id="photo" src="" style="width: 750px; height: 480px;border:1px solid #CCC;" />
	      </div>
