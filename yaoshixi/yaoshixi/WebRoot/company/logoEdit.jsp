	...
	<div class="container demo">
	  <div style="float: left; width: 99%;">
	      <div class="instructions" style="margin-bottom:10px;"> 
	     	 ...
	     	 <fieldset>
	     	  	<legend>请选择jpg图片：</legend>
		    		...
		    		<form id="photoForm" action="company/saveLogo" onsubmit="return uploadAjaxForm(this);" style="text-align:right">
	    ...
	    <div id="photoDiv" class="frame"  style=" width: 300; height: 300;display:none;">
	      <div style="width:400px; height:400px; float:left;"><img id="photo" src="" style="width: 300; height: 300;border:1px solid #CCC;" /></div>
