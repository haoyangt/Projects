            ...
            <div class="kt_bo">
	          ...
	          <form action="company/job/addOnWx" method="post" >
	            ...
	            <p class="login_top"><textarea name="otherReq" id="otherReq" placeholder="请输入该职位的其他要求" cols="10" rows="5" style="width:100%"></textarea>
	             ...
	             <div class="ktname_b">问题一<span class="kt_font_x"></span></div>
	            <p class="login_top"><textarea name="interQuestionsOne" id="interQuestionsOne" placeholder="请输入第一个问题" cols="10" rows="5" style="width:100%"></textarea>
	            
	             <div class="ktname_b">问题二<span class="kt_font_x"></span></div>
	            <p class="login_top"><textarea name="interQuestionsTwo" id="interQuestionsTwo" placeholder="请输入第二个问题" cols="10" rows="5" style="width:100%"></textarea>
	            
	             <div class="ktname_b">问题三<span class="kt_font_x"></span></div>
	            <p class="login_top"><textarea name="interQuestionsThree" id="interQuestionsThree" placeholder="请输入第三个问题" cols="10" rows="5" style="width:100%"></textarea>
	            
	             <div class="ktname_b">问题四<span class="kt_font_x"></span></div>
	            <p class="login_top"><textarea name="interQuestionsFour" id="interQuestionsFour" placeholder="请输入第四个问题" cols="10" rows="5" style="width:100%"></textarea>
	            
	             <div class="ktname_b">问题五<span class="kt_font_x"></span></div>
	            <p class="login_top"><textarea name="interQuestionsFive" id="interQuestionsFive" placeholder="请输入第五个问题" cols="10" rows="5" style="width:100%"></textarea>
