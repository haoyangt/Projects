...
<body>
   ...
   <c:if test="${msg=='' || msg == null }">
	<form class="tb_int" action="" method="post">
		...
		<table>
		    <tr>
				<td><span class="login_top">评价员工：</span></td>
				<td><textarea style="width:200px;height:100px" class="add_content  login_input" placeholder=""  id="add_content"></textarea></td>
			</tr>
			<tr>
				<td></td>
				<td style="text-align:right;width:200px">你可以输入<span style="color:red">200</span>字</td>
			</tr>
			<tr>
				<td></td>
				<td>
					<p style="width:200px;margin-top:20px"><input class="btn_style1" id="sendEmail" type="button" value="提交"><input class="btn_cancel" type="button" onclick="closeWindow();" value="取消"></p>
				</td>
			</tr>
		</table>
	</form>
...
<script type="text/javascript">
	...
	require(["jquery", "artLab", 'res/artDialog/dialog-iframe'], function($, artLab, art){
		$("input#sendEmail").click(function(){
	    	...
	    	$.ajax({
				type:'POST',
				url:'company/saveRelevance',
				data:{"uId":userId,"cId":companyId,"status":1,"content":content,"jobId":jobId},
				dataType:'json',
