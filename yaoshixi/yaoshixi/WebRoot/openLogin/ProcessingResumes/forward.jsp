	...
	<form class="tb_int" action="" method="post">
		...
		<table>
			<tr>
			    ...
			    <td><input class="login_input" style="width: 200px" type="text" id="targetEmail"  placeholder=""></td>
		    </tr>
		    <tr>
			...
			<tr>
				<td></td>
				<td style="text-align:right;width:200px">你可以输入<span style="color:red">100</span>字</td>
			</tr>
			<tr>
				<td></td>
				<td>
	...
	require(["jquery", "artLab", 'res/artDialog/dialog-iframe'], function($, artLab, art){
		...
		function forwardAjax() {
			...
			$.ajax({
				...
				data:{"userId": userId, "targetEmail": targetEmail, "content": content},
				dataType:'json',
