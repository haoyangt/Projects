...
<div class="xiangq" id="vsShowDiv_${s.index }">
       ...
       <div style="position: relative;">
        <c:forEach items="${itSkillJt }" var="itSkillJt" varStatus="s">  
         <input type="hidden" id="itSkillIdJt" value="${itSkillJt.skill }">  
        		<div class="xiangq" id="vsShowJtDiv_${s.index }">
                           <div class="xq_xin">
                           <div class="shix_li">
                           		<p style="height: 6px;">${itSkillJt.skill }
         ...
         <div style="position: relative;">
            ...
            <input type="hidden" id="itSkillPtId" value="${itSkillPt.skill }">
         		<div class="xiangq" id="vsShowPtDiv_${s.index }">
                    	<div class="xq_xin">
                           <div class="shix_li">
                           		<p style="height: 6px;">${itSkillPt.skill }
...
function addVocation(){
	var $form = $("#vocationalSkillsForm");
	 $.ajax({
			type:'POST',
			url:'addVocationalSkillsPhone/${userId}',
