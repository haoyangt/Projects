		...
		<div id="content" style="display:none">
				...
				<div class="wrap">
                    <div class="t1-txt qq pt-page-moveFromTop">我是<label style="color:#ff556d">${userBasicInfo.userName }</label>，听说你在找我？</div>
                    	<c:if test="${fn:contains(userBasicInfo.headImg,'http://wx.qlogo.cn')}">
                   			 <img class="img_4 pt-page-moveFromTop" height="140px;" src="${userBasicInfo.headImg}"> 
                   			  <%--<img class="img_4 pt-page-moveFromTop" height="140px;"  src="/res/jianl/img/t.jpg">--%>
                   		</c:if>
                    ...
                    <div class="sexy qq pt-page-moveFromTop">
	                 <c:if test="${userBasicInfo.gender==0 || userBasicInfo.gender=='' || userBasicInfo.gender==null }">
				        	男<img src="/res/jianl/img/iconfont-nan.png" />
				        </c:if> 
				        <c:if test="${userBasicInfo.gender==1 }">
	                       	 女 <img src="/res/jianl/img/iconfont-nv.png" />
				        </c:if> 
			        </div>
                    
                    <div class="gzcity qq pt-page-moveFromTop">${userBasicInfo.city }</div>
                    <c:if test="${userBasicInfo.giveHRword != '' && userBasicInfo.giveHRword != null }">
                    	<div class="gzcity qq pt-page-moveFromTop" style="top:75%;">"${userBasicInfo.giveHRword }"</div>
                    </c:if>
					<img class="icon pt-page-moveIconUp" src="/res/jianl/img/icon_up.png" />
				</div>
			</div>
			<div class="page page-2-1 hide">
				<div class="wrap">
					<!-- <img class="img_1 hide pt-page-moveCircle" src="/res/jianl/img/t2-t.png" />
					<div class="t2-txt1 hide qq pt-page-moveCircle">教育背景</div> -->
					<div class="img_2 hide qq pt-page-moveFromLeft"><img src="/res/jianl/img/xue.png" width="35px"/><br/><span>学校</span></div>
					<div class="img_3 hide qq pt-page-moveFromLeft"><img src="/res/jianl/img/zhuan.png" width="30px"/><br/><span>专业</span></div>
					<div class="img_4 hide qq pt-page-moveFromLeft"><img src="/res/jianl/img/da.png" width="30px"/><br/><span>学历</span></div>
					<div class="img_5 hide qq pt-page-moveFromLeft"><img src="/res/jianl/img/biaoqian.png" width="27px"/><br/><span>年级</span></div>
					<div class="img_6 hide qq pt-page-moveFromLeft"><img src="/res/jianl/img/dianhua.png" width="30px"/><br/><span>电话</span></div>
					<div class="img_7 hide qq pt-page-moveFromLeft"><img src="/res/jianl/img/youxiang.png" width="30px"/><br/><span>邮箱</span></div>
                  <!--   <img class="img_2 hide pt-page-moveFromLeft" src="/res/jianl/img/xue.png" /> -->
                    <!-- <img class="img_3 hide pt-page-moveFromLeft" src="/res/jianl/img/zhuan.png" />
                    <img class="img_4 hide pt-page-moveFromLeft" src="/res/jianl/img/da.png" />
                    <img class="img_5 hide pt-page-moveFromLeft" src="/res/jianl/img/biaoqian.png" />
                    <img class="img_6 hide pt-page-moveFromLeft" src="/res/jianl/img/dianhua.png" />
                    <img class="img_7 hide pt-page-moveFromLeft" src="/res/jianl/img/youxiang.png" /> -->
			...
			<div class="page page-3-1 hide">
                   <div class="wrap">
					...
					<div class="img_2 hide qq pt-page-moveFromLeft"><img src="/res/jianl/img/date.png" width="25px"/><br/><span>可实习时间</span></div>
					<div class="img_3 hide qq pt-page-moveFromLeft"><img src="/res/jianl/img/yue.png" width="25px"/><br/><span>可实习月份</span></div>
					<div class="img_4 hide qq pt-page-moveFromLeft"><img src="/res/jianl/img/ad.png" width="25px"/><br/><span>可实习场所</span></div>
					<div class="img_5 hide qq pt-page-moveFromLeft"><img src="/res/jianl/img/chuang.png" width="25px"/><br/><span>住宿意愿</span></div>
                   <!--  <img class="img_2 hide pt-page-moveFromLeft" src="/res/jianl/img/date.png" />
                    <img class="img_3 hide pt-page-moveFromLeft" src="/res/jianl/img/yue.png" />
                    <img class="img_4 hide pt-page-moveFromLeft" src="/res/jianl/img/ad.png" />
                    <img class="img_5 hide pt-page-moveFromLeft" src="/res/jianl/img/chuang.png" /> -->
			 ...
			 <div class="wrap stag">
				...
				<!--  <img class="xing1 hide" src="/res/jianl/img/xing1.png" />
				 <img class="xing2 hide" src="/res/jianl/img/xing2.png" />
				 <img class="xing3 hide" src="/res/jianl/img/xing3.png" />
				 <img class="xing4 hide" src="/res/jianl/img/xing4.png" />  -->
				 <img class="icon  pt-page-moveIconUp" src="/res/jianl/img/icon_up.png" />
				</div>
			...
			<div class="page page-8-1 hide">
				<div class="wrap">
					<div class="ftop-con">
						<p><span class="fenxiang">分享：${userBasicInfo.sharetimes}次</span></p>
						<p><span class="chakan">浏览：${userBasicInfo.viewCount}次</span></p>
						<p><span class="kong">状态：还在找工作哟</span></p>
					</div>
...
<script src="/res/jianl/js/index.js"></script>
...
if(certificate != "" && certificate != null){
	...
	for(var j=0;j<fss.length;j++){
		str = str+"<div class=\"t4-tag"+(Number(j))+" hide qq pt-page-scaleUp\"><table><tr><td>"+fss[j]+"</td></tr></table></div>";
	}
...
if(skill != "" && skill != null){
	...
	for(var i=0;i<fsd.length;i++){
		sttr = sttr+"<div class=\"t4-tag"+(Number(i))+" hide qq pt-page-scaleUp\"><table><tr><td>"+fsd[i]+"</td></tr></table></div>";
	}
...
if(experience != "" && experience != null){
	...
	for(var n=0;n<fs.length;n++){
		ext = ext+"<div class=\"t4-tag"+(Number(n))+" hide qq pt-page-scaleUp\"><table><tr><td>"+fs[n]+"</td></tr></table></div>";
	}
