	...
	<div class="main">
		<div class="main_j">
			...
			<div class="neir" style="margin-bottom: 50px;">
				...
				<p>
					<label>公司主页：</label>
						<a href="${homePage }" target="_blank" style="width:300px; overflow:hidden;text-overflow:ellipsis;white-space:nowrap;display: block;">${homePage}</a>
				</p>
		...
		<c:if test="${diliverStatus == 1 }">
			<a href="javascript:void(0)" class="btn_tjl" >
		...
		a_diliver.click(function(){
			...
			var quantity = '${sessionScope.quantityHH}';
			 if('${sessionScope.userId}'!='' && '${sessionScope.roleId}' != '1' && ratio!='' && userName!='' && email!='' && quantity>0){
					createArtBox("让企业hr了解你更加适合我们企业或这个岗位的个人优势", "user/declarationx/"+jobId);
					$(this).hide();
