...
<div id="page">
  <div class="cont">
    ...
    <section class="login">
    <form action="user/wJlLogin" method="post">
	     <div class="jj">
	       ...
	       <input name="password" id="password" type="password" class="txtpwd" validate="required::请输入密码" placeholder="请输入密码">
	       	<p><font size="2" color="#9F9FA9">还没有要实习账号？点击注册马上加入要实习</font></p>
	       <p id="spanTex">${msg }</p>
	     </div>
	    <div class="jj">
	    	<input type="submit" id="tijiaoDr" style="display: none;">
	    	<input type="button" onclick="userLogin()" class="btnlg" value="登&nbsp;&nbsp;&nbsp;&nbsp;录" style="width: 45%;float: left;">
	    	<a href="m/weixRegist.jsp"><input type="button" class="btnlg" value="注&nbsp;&nbsp;&nbsp;&nbsp;册" style="width: 45%;float: right;"></a>
	    </div>
    </form>
    </section>
    <br>
