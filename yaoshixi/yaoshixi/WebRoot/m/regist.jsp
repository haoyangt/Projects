...
<div id="page">
  <div class="cont">
    ...
    <section class="login">
    <form action="user/registPhone" method="post">
    <input type="hidden" name="roleId" id="roleId" value="2">
    <span id="xues" class="btnspan son" onclick="role('2')" >我是学生</span> <span id="qiye" class="btnspan" onclick="role('1')">企业HR</span>
	     <div class="jj">
	       <input name="email" id="email" type="text" class="txtname" validate="email::请输入常用邮箱" placeholder="请输入注册邮箱地址">
	       <p></p>
