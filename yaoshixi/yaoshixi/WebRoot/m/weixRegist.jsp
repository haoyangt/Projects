...
<div id="page">
	<!-- <div class="zhank"></div> -->
 	<div class="cont">
 	<section class="login" style="width:100%;padding:20px 0;overflow: hidden;">
 	<div class="login_left" style="padding-left:5px;width:auto;">
    <form action="user/regist" method="post" id="form" onsubmit="return validate();" >
    	...
    	<!-- <span class="login_btnx login_btnx_b" style="background-size:140px;width:140px; padding-left:0;">我是学生</span> <span class="login_btnx login_btnx_b" style="background-size:140px;width:140px;padding-left:0;">企业HR</span> -->
    	</div>
        ...
        <div class="login_top" style="text-align: center;">
        	...
        	<input type="button"  id="regisetes" value="注册" class="btn_style1 btn_w" style="-webkit-appearance:none;">
        </div>
    </form>
